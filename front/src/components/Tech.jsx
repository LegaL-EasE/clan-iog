  ...
  <div className="tech">
   <div className="tech-item">
      ...
      <div className="tech-item__content">
        <p>
          In order to arrange teams or host custom games without a host-bot, you will need to portforward.  This simple process will alloe you to invite others to arranged team games and team tournament games as well as permit you to host your own custom games.  You will need to open ports 6112 - 6119.  To do this, first you log in to your router.  Most routers will log you in with an IP address (example: <a href="https://192.168.1.1"  target="_blank"> 192.168.1.1</a>) but some require other addresses like NetGear's <a href="http://www.routerlogin.net"  target="_blank">http://www.routerlogin.net</a>.  But most use your IP which can be found by opening your Command Prompt. A fast way to launch this window is to press the Win + R keys on your keyboard. Then, type cmd or cmd.exe and press Enter or click/tap OK.  If you have trouble finding the way to log in go to: <a href="https://portforward.com/router.htm"  target="_blank">portforward.com/router.htm</a> and look up your router make and model. The username and password are almost always: admin and password. Find the section for Port Forwarding in your menu options. The set the protocol to TCP and open ports 6112-6119. Save. And you are done.  You can also plug directly into you modem and this should also allow you to host.
        </p>
      </div>
    </div>
    <hr/>
    <div className="tech-item">
      ...
      <div className="tech-item__content">
       ...
       <hr/>
    <div className="tech-item">
      <div className="tech-item__header">Game Casting</div>
      <div className="tech-item__content">
        <p>
          Currently only a few members are screen casting games for twitch or youtube.  Clan iOg encourages it's members to try using OBS Studio from <a href="https://obsproject.com/" target="_blank">https://obsproject.com/</a>. This free software is fairly easy to set up and is far superior to other "shareware" or open source programs.  Members who record their games or replays can have their videos posted to the clan youtube channel.
        </p>
	</div>
      ...
      <div className="tech-item__content">
        <h3>[iOg]Defender</h3>
		<p>
          Defending Clan iOg against spam, trolls and hackers since 2017, [iOg]Defender is a <a href="http://www.stealthbot.net"  target="_blank">StealthBot</a> v2.7 beta Build 490.  Typing '.pingme' gets your ping or .ping &lt;user name&gt; gets another user's ping. Other commands you can use are: .votekick &lt;user&gt; | .roll &lt;#&gt; | .vote &lt;#&gt; | .math &lt;#+#&gt; | .banned | .whois | .whoami | .about | .votekick &lt;player name&gt;</p>
		  <h3>[ioG]Host-bot</h3>
		  <p>
